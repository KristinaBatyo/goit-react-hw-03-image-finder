import axios from 'axios';
    ...
    export const fetchArticlesWithQuery = async (name, page) => {
        const response = axios.get(`https://pixabay.com/api/?q=${name}&page=${page}&key=30952901-4af86608fbbf1ce290900eb34&image_type=photo&orientation=horizontal&per_page=12`);
        return response.data;
      };
